...
public class ConsumerExample {
	...
	public static void main(String[] args) {
...

		{
		    ...
		    //URL url = new URL("http://localhost:8083/welcome/student?name='Katie%20Callahan'&gender='FEMALE'&id=456789");
		    URL url = new URL("http://localhost:8083/welcome/student?name='Katie%20Callahan'&id=456789");
			...
			String jsonMessage = (String) jobj.get("message");
			long jsonId = (long) jobj.get("id");
			String jsonGender = (String) jobj.get("gender");
			System.out.println(jsonMessage + jsonGender + jsonId);
			// Store the JSON object in JSON array as objects (For level 1 array element i.e
			// Results)
			//JSONArray jsonarr_1 = ((JSONArray) jobj.get("message"));
